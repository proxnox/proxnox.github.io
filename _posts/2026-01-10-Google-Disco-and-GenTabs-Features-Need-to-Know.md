---
layout: article
title: What is Google Disco and GenTabs? - Everything You Need to Know in 2026
description: Things to know about Google Diso app and GenTabs features better than Discovery in almost everything specially in powerful webapp and helpful content creation in 2026.
tags: AI Google Webapp Gentab
...
<div>{%- include extensions/youtube.html id='I-rAE40ggbc' -%}</div>
...
*All this information is Open-Source and can be slightly Up or Down and also avaliable at [Google's Disco](https://blog.google/innovation-and-ai/models-and-research/google-labs/gentabs-gemini-3/){:target="_blank"}'s official site, you can also get more deeper information from here.*
